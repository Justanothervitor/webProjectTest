...
public class ProductProperties implements Serializable{
	...
	private Set<CategoryProperties> categories = new HashSet<>();
	...
	public ProductProperties(Long id, String name, String description, Double price, String imgUrl)
	{
		super();
		this.id = id;
		this.name = name;
	...
	public Set<CategoryProperties> getCategories() {
		return categories;
	}
	@JsonIgnore
	public Set<ClientOrder> getOrders()
	{
		Set<ClientOrder> set = new HashSet<>();
