...
public class testConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		ClientOrder o1 = new ClientOrder(null, Instant.parse("2023-06-15T16:35:08Z"),ClientOrderStatus.PAID,u1);
		ClientOrder o2 = new ClientOrder(null, Instant.parse("2023-06-15T19:04:08Z"),ClientOrderStatus.WAITING_PAYMENT,u2);
		ClientOrder o3 = new ClientOrder(null, Instant.parse("2023-06-15T23:30:08Z"),ClientOrderStatus.SHIPPED,u1);
